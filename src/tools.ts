...
export function registerTools(server: McpServer): void {
  ...
  const toolToRegister = echoTool;

  server.registerTool(
    toolToRegister.name,
    {
      title: toolToRegister.title,
      description: toolToRegister.description,
      ...
      inputSchema: toolToRegister.inputSchema,
      outputSchema: toolToRegister.outputSchema,
      annotations: toolToRegister.annotations,
    },
    (args, extra) => toolToRegister.implementation(server, args, extra),
  );
